          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                ...
                alt="World Map"
                className="w-full h-45 md:h-85 object-cover rounded-xl"
                onError={(e) => {
                  e.currentTarget.src = "https://images.unsplash.com/photo-1564053489984-317bbd824340?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2128&q=80";
                }}
              />
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-white opacity-90">
               Reach out to us anytime. Let’s build something great together.
              </p>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg border-0 focus:ring-2 focus:ring-white focus:outline-none bg-white"
                />
                <input
                  type="text"
                  name="lastName"
              ...
              <textarea
                ...
                required
                rows={6}
                className="w-full px-4 py-3 rounded-lg border-0 focus:ring-2 focus:ring-white focus:outline-none resize-none bg-white"
              />
            ...
            >
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-3 rounded-lg border-0 focus:ring-2 focus:ring-white focus:outline-none text-gray-900 bg-white"
                />
                <button
                  type="submit"
